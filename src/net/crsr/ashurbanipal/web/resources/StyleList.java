...
public class StyleList {
  ...
  private static final String SEARCH_QUERY = "select dists.dist, meta.* from pos_distances(?) dists inner join book_metadata meta on (dists.etext_no = meta.etext_no) order by dists.dist offset ? limit ?";
  
  private static final Logger log = LoggerFactory.getLogger(StyleList.class);
